...
if (empty($student_name)) $error_message .= "- Nama Mahasiwa
belum diisi <br>";
if (empty($student_number)) $error_message .= "- No Induk
Mahasiswa (NIM) belum diisi <br>";
if (empty($student_address)) $error_message .= "- Alamat
Mahasiswa belum diisi <br>";
...
if ($check === false) {
$error_message .= "- Mohon upload file gambar (gif, png,
atau jpg) <br>";
}
}
...
rows="5" placeholder="Alamat Anda"><?= $student_address
?></textarea></td>
</tr>
<tr>
<td>Tanggal Lahir*</td>
...
<td>
<input type="checkbox"
name="student_skill_html" value="html" id="html" <?= $student_skill_html
?>><label for="html">HTML</label>
<input type="checkbox"
name="student_skill_css" value="css" id="css" <?= $student_skill_css
?>><label for="css">CSS</label>
<input type="checkbox"
name="student_skill_js" value="javascript" id="javascript" <?=
$student_skill_js ?>><label for="javascript">Javascript</label>
<input type="checkbox"
name="student_skill_php" value="php" id="php" <?= $student_skill_php
